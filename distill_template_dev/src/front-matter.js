...
export function mergeFromYMLFrontmatter(target, source) {
  ...
  if (source.updated) {
    if (source.updated instanceof Date) {
      target.updatedDate = source.updated;
    } else if (source.updated.constructor === String) {
      target.updatedDate = new Date(source.updated);
    }
  }
...
export class FrontMatter {
  ...
  get updatedMonthPadded() {
    return zeroPad(this.updatedDate.getMonth() + 1);
  }
  ...
  get updatedDayPadded() {
    return zeroPad(this.updatedDate.getDate());
  }
  ...
  assignToObject(target) {
    ...
    if (this.publishedDate) {
      ...
      target.updatedYear = this.updatedYear;
      target.updatedMonth = this.updatedMonth;
      target.updatedDay = this.updatedDay;
      target.publishedMonthPadded = this.publishedMonthPadded;
      target.publishedDayPadded = this.publishedDayPadded;
      target.updatedMonthPadded = this.updatedMonthPadded;
      target.updatedDayPadded = this.updatedDayPadded;
    }
    if (this.updatedDate) {
